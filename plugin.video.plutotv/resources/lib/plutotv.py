...
class PlutoTV(object):
    ...
    def buildM3U(self, channel):
        ...
        self.m3uList.append(litem%(channel['number'],channel['number'],channel['name'],logo,';'.join(group),str(radio).lower(),channel['name'],urls))
        return True
    ...
    def addProgram(self, channel, program):
        ...
        tz      = (timezone()//100)*60*60
        pitem   = {'channel'     : str(channel['number']),
